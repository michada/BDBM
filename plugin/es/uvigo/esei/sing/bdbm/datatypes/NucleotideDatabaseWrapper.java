...
public class NucleotideDatabaseWrapper 
extends SequenceEntityWrapper<NucleotideDatabase>
implements NucleotideDatabase {
	public NucleotideDatabaseWrapper(NucleotideDatabase database) {
		super(database);
	}
