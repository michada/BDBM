...
public abstract class AbstractBinariesExecutor<B extends Binaries> implements BinariesExecutor<B> {
...
//		log.info("Executing command: " + commandString);
	...
	private static class LoggerCallbackInputThread extends Thread {
		private final String command;
		private final BufferedReader reader;
	...
	private static class LoggerCallbackErrorThread extends Thread {
		private final String command;
		private final BufferedReader reader;
		private final List<InputLineCallback> callbacks;
